    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 leading-tight">Main Inventory</h1>
            <p className="text-xs text-slate-500 font-medium">Consolidated view of purchases, sales, and returns</p>
          </div>
        </div>
      </div>
