...
import { ArrowLeft, Search, Truck, ChevronLeft, ChevronRight, Calendar, Filter, Lock, Building2 } from 'lucide-react';
  ...
  const fetchAllocations = async (currentPage, currentAllocType, currentProductId, currentVariantId, targetWarehouseId) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showToast("Failed to fetch allocations");
      }
    } catch (err) {
  ...
  if (!isAllowed({ id: 'warehouse-allocations' }) && !isAllowed({ id: 'allocations' })) {
    return (
      <div className="flex flex-col items-center justify-center h-[80vh] text-center">
        ...
        <p className="text-slate-500 mt-2">You do not have permission to view warehouse allocations.</p>
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 leading-tight">Warehouse Allocations</h1>
            <p className="text-xs text-slate-500 font-medium">Audit logs and stock movements for this warehouse</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
            ...
            <div className="relative w-full md:w-40">
              ...
              >
                ...
                <option value="purchase_to_warehouse">Purchase To Warehouse</option>
              ...
              {warehouse_id === 'all' ? (
                <tr>
                  <td colSpan="7" className="p-10 text-center text-slate-500 font-bold">
                    Please select a specific warehouse from the dropdown above to view its allocations.
                  </td>
                </tr>
              ) : isLoading ? (
                <tr>
                ...
                <tr>
                  <td colSpan="7" className="p-10 text-center text-slate-500 font-bold">
                    No allocation records found for this warehouse.
                  </td>
                </tr>
              ) : (
