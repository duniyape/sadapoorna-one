...
export default function Home() {
  ...
  const isAllowed = (item) => {
    ...
    if (['home', 'ai-suite', 'whatsapp', 'beat-mgmt', 'product-units', 'product-attributes', 'packing-types', 'products', 'warehouses', 'vehicles', 'vendors', 'purchase-orders', 'warehouse-in', 'warehouse-inventory', 'vehicle-in', 'main-inventory', 'account-master', 'accounting-vouchers', 'employee-cash'].includes(item.id)) return true;
