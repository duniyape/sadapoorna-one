      ...
      <div className="flex-1 overflow-y-auto py-2 px-2 space-y-3 custom-scrollbar">
        {(() => {
          ...
          const isAllowed = (item) => {
            if (['home', 'ai-suite', 'whatsapp', 'product-units', 'product-attributes', 'packing-types', 'products', 'warehouses', 'vehicles', 'vendors', 'purchase-orders', 'main-inventory'].includes(item.id)) return true; 
