...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      '^/(branches|masters|users|auth|data-access-hierarchy|access|customer|product-units|attributes|products|variants|get|packing-types|whatsapp|warehouses|vehicles)/': {
        target: API_BASE_URL,
        changeOrigin: true,
      },
    }
